...
theme.set_highlights = function()
	...
	hl(0, "CursorLineNr", { fg = c.orange, bg = "NONE", bold = true })
	hl(0, "Folded", { fg = c.light_gray, bg = c.alt_bg })
	hl(0, "FoldColumn", { fg = c.light_gray, bg = c.alt_bg })
	hl(0, "LineNr", { fg = c.light_red, bg = "NONE" })
	hl(0, "FloatBorder", { fg = c.visual, bg = c.bg })
	...
	hl(0, "Visual", { fg = "#D9AE7E", bg = c.visual })
	...
	hl(0, "Search", { fg = "#D9AE7E", bg = c.visual })
	hl(0, "IncSearch", { fg = "#D9AE7E", bg = "NONE" })
	hl(0, "Substitute", { fg = "#D9AE7E", bg = c.visual })
	...
	hl(0, "Variable", { fg = "#abb2bf", bg = "NONE" })
	...
	hl(0, "Type", { fg = "#adff00", bg = "NONE" })
	hl(0, "Function", { fg = "#ff062c", bg = "NONE" })
	hl(0, "Keyword", { fg = "#ff1aff", bg = "NONE", italic = true })
	hl(0, "Conditional", { fg = c.magenta, bg = "NONE" })
	hl(0, "Repeat", { fg = c.magenta, bg = "NONE" })
	hl(0, "Operator", { fg = c.orange, bg = "NONE" })
	...
	hl(0, "Tag", { fg = c.blue, bg = "NONE", italic = true })
	...
	hl(0, "@punctuation.special", { fg = c.dark_red, bg = "NONE" })
	...
	hl(0, "@field", { fg = c.light_red, bg = "NONE" })
	hl(0, "@property", { fg = c.light_red, bg = "NONE" })
	hl(0, "@variable", { link = "Variable" })
	hl(0, "@variable.builtin", { fg = c.yellow, bg = "NONE" })
	hl(0, "@constant", { link = "Constant" })
	hl(0, "@constant.builtin", { fg = c.yellow, bg = "NONE" })
	...
	hl(0, "@tag", { link = "Tag" })
	hl(0, "@tag.attribute", { fg = c.light_red, bg = "NONE", italic = true })
	hl(0, "@tag.delimiter", { fg = c.light_gray, bg = "NONE" })
	...
	hl(0, "MatchWord", { fg = "NONE", bg = c.indent })
	hl(0, "MatchWordCur", { fg = "NONE", bg = c.indent })
	hl(0, "MatchParen", { fg = c.hint, bg = "NONE" })
	hl(0, "MatchParenCur", { fg = "NONE", bg = "NONE" })

	-- IndentBlankline
	hl(0, "IndentBlanklineChar", { fg = c.indent, bg = "NONE" })
	hl(0, "IndentBlanklineContextChar", { link = "Comment" })
	...
	hl(0, "TelescopePromptTitle", { fg = c.cyan, bg = "NONE" })
	hl(0, "TelescopePromptPrefix", { fg = c.fg, bg = "NONE" })
	hl(0, "TelescopeResultsTitle", { fg = c.fg, bg = "NONE" })
	hl(0, "TelescopePreviewTitle", { fg = c.fg, bg = "NONE" })
	hl(0, "TelescopePromptCounter", { fg = c.light_gray, bg = "NONE" })
	...
	hl(0, "NvimTreeCursorLine", { fg = "NONE", bg = "#383D49" })
	...
	hl(0, "NvimTreeEmptyFolderName", { fg = "#6c7380", bg = "NONE", italic = true })
	hl(0, "NvimTreeGitIgnored", { fg = "#6c7380", bg = "NONE", italic = true })
	...
	hl(0, "CmpItemKindVariable", { fg = c.light_red, bg = "NONE" })
	hl(0, "CmpItemKindField", { fg = c.light_red, bg = "NONE" })
	hl(0, "CmpItemKindProperty", { fg = c.light_red, bg = "NONE" })
	hl(0, "CmpItemKindEnumMember", { fg = c.yellow, bg = "NONE" })
	hl(0, "CmpItemKindConstant", { fg = c.orange, bg = "NONE" })
	hl(0, "CmpItemKindKeyword", { fg = c.magenta, bg = "NONE" })
	hl(0, "CmpItemKindModule", { fg = c.yellow, bg = "NONE" })
	hl(0, "CmpItemKindValue", { fg = c.orange, bg = "NONE" })
